...
simple_x, simple_y = zip(*simple_lists[:20]) # unpack a list of pairs into two tuples

plt.xlabel("20 most common chords in {} C major pieces not including complex chords".format(simple_nr))
